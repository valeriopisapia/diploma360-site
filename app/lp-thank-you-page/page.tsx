...
import '../lp/lp.css'
import './lp-thank-you-page.css'

/**
 * Thank-you page for the Ads landing funnel. Reached only via a client-side
 * redirect from the LeadForm (origine="landing-ads"). Uses the LP chrome
 * (LpHeader + LpFooter) so it stays visually inside the ad funnel; no nurture
 * links back to the indexed site. noindex + excluded from sitemap; robots.ts
...
export default function LpThankYouPage() {
  return (
    <>
      ...
      <main className="lpty">
        <div className="wrap">
          <div className="lpty-hero">
            <div className="lpty-check">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
          ...
          <div className="lpty-steps">
            <div className="lpty-step">
          ...
          <div className="lpty-now">
            <div className="lpty-now-txt">
            ...
            <div className="lpty-now-acts">
              ...
              <a className="btn btn-outline btn-lg" href="tel:0684280999">
                <svg
                  viewBox="0 0 24 24"
                  width="18"
                  height="18"
